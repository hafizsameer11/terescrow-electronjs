...
const API_ENDPOINT = {
  ...
  ADMIN: {
    ...
    merchants: API_ADMIN_BASE + '/merchants',
    strowalletConfig: API_ADMIN_BASE + '/merchants/strowallet/config',
    strowalletTopup: API_ADMIN_BASE + '/merchants/strowallet/topup',
    merchantsPalmpayBanks: API_ADMIN_BASE + '/merchants/palmpay/banks',
    merchantsPalmpayVerifyAccount: API_ADMIN_BASE + '/merchants/palmpay/verify-account',
    busha: API_ADMIN_BASE + '/busha',
    bushaCustomer: (id: string) => API_ADMIN_BASE + '/busha/customers/' + encodeURIComponent(id),
    bushaCustomerKyc: (id: string) => API_ADMIN_BASE + '/busha/customers/' + encodeURIComponent(id) + '/kyc',
    bushaCustomerVerify: (id: string) => API_ADMIN_BASE + '/busha/customers/' + encodeURIComponent(id) + '/verify',
