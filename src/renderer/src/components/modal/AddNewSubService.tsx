      ...
      <div className="relative bg-white rounded-lg shadow-lg p-6 w-[500px]">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            />
            <label className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-1 left-4 bg-white px-1 peer-placeholder-shown:translate-y-3 peer-placeholder-shown:scale-100 peer-focus:scale-75 peer-focus:-translate-y-4">
              Title
            </label>
          </div>
