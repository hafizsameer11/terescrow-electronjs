...
const ChatUnSuccessFullModal: React.FC<ChatConfirmModalProps> = ({ onClose, onConfirm }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg w-[90%] max-w-md p-6 relative shadow-lg">
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800">UnSuccessFul transaction?</h2>
...
export default ChatUnSuccessFullModal;
