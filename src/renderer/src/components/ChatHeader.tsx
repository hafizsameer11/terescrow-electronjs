...
const ChatHeader: React.FC<HeaderProps> = ({
    ...
    },
    {
        "id": 2,
        "title": "",
        "description": "Customer is kind and reputable and respectful, doesnt stress me at all, but does not like waiting for too long",
        "date": "Nov 7, 2024 - 10:22 am",
        "author": "Dave",
        "pinned": false
    },
    ...
    return (
        <>
            <div className="flex items-center justify-between bg-gray-100 px-4 py-3 rounded-t-xl">
                {/* Left Section */}
                ...
                <div className="flex items-center space-x-2">
                    ...
                    {isCustomRateModalOpen && (
                        <CustomRateModal onSendRate={onSendRate} onClose={() => setIsCustomRateModalOpen(false)} />
                    )}
                    ...
                    <div className="relative">
                        ...
                        {/* Modal */}
                        {isNoteModalOpen && (
                            <ChatNoteModal notes={notesData} onClose={handleCloseNoteModal} />
                        )}
                    </div>
            ...
            {/* Modals */}
            {isSuccessModalOpen && <ChatConfirmModal onClose={() => setIsSuccessModalOpen(false)} onConfirm={handleConfirm} />}
            {isCancelModalOpen && <ChatCancelModal onClose={() => setIsCancelModalOpen(false)} onSubmit={handleCancel} />}
        </>
    );
};
